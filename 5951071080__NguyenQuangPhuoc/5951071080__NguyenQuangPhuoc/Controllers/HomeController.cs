...
namespace _5951071080__NguyenQuangPhuoc.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            List<Emplolyee> list = new List<Emplolyee>();
            foreach(DataRow dr in ds.Tables[0].Rows)
            {
                list.Add(new Employee
                {
                    Sr_no = Convert.ToInt32(dr["Sr_no"]),
                    Emp_name = dr["Emp_name"].Tosing(),
                    City = dr["City"].Tosing(),
                    State = dr["State"].Tosing(),
                    Country = dr["Country"].Tosing(),
                    Department = dr["Department"].Tosing(),
                });
            }
            return View(list);
        }
